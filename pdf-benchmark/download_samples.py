...
of different sizes and types for testing PDF text extraction performance.
"""
...
# Using a variety of document types and sizes with text layers
SAMPLE_PDFS = [
    ...
    SamplePDF(
        ...
        description="Python 3.12 documentation (zipped) - will extract tutorial",
        expected_size_kb=15000,
    ),
    SamplePDF(
    ...
    # Documents with various formatting
    SamplePDF(
...
def download_samples(output_dir: Path, skip_existing: bool = True, rate_limit: float = 2.0) -> list[Path]:
    """
